...
SECRET_KEY = 'django-insecure-o)71%m*155)r7&y@ia=nit-9sv8t5_0kr9haz!o!!b_%q=29g8'
...
STATIC_URL = 'static/'
# STATICFILES_DIRS = [BASE_DIR / 'static'] for offline
STATIC_ROOT = BASE_DIR / 'static'  #! online for online
